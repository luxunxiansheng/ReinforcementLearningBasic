...
def test_approximation_evaluation(env):
    ...
    semigradienttdnevalution = SemiGradientTDNEvalution(
        polynomialbasesfunc_semi, b_policy, 5, env, distribution=distribution)
    ...
    gradientmcevalution = GradientMonteCarloEvaluation(
        polynomialbasesfunc_mc, b_policy, env, distribution=distribution)
    ...
    gradientmcevalution = GradientMonteCarloEvaluation(
        fourierBasesValueFunction_mc, b_policy, env, distribution=distribution)
    gradientmcevalution.evaluate()
